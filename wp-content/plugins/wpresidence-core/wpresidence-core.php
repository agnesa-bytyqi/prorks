...
function wpestate_return_all_fields($is_mandatory=0){
    ...
    $all_submission_fields=$all_mandatory_fields=array(
        ...
        'property_year_tax'             =>  esc_html__('Yearly Tax Rate','wpresidence'),
        'property_hoa'                  =>  esc_html__('Homeowners Association Fee(monthly)','wpresidence'),
        'property_year_tax'             =>  esc_html__('Yearly Tax Rate','wpresidence'),
        'property_hoa'                  =>  esc_html__('Homeowners Association Fee','wpresidence'),
     ...
     if ( get_option('wpresidence_theme_setup')!=='yes') {
        $page_creation=array(
                ...
                array(  
                    ...
                    'template'  =>'front_property_submit.php',
                ),
