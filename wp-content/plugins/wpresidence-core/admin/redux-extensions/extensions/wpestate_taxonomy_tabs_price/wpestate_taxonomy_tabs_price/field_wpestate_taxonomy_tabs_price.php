            ...
            if( isset($wpresidence_admin['wp_estate_adv6_taxonomy_terms'] ) && is_array($wpresidence_admin['wp_estate_adv6_taxonomy_terms']) ){
                ...
                if(isset($term->name)){
                    print '<div class="field_row">
                        <div class="field_item">'.esc_html__('Price Slider Values for ','wpresidence-core').'<strong>'.$term->name.'</strong></div>

                        <div class="field_item">
                           <input type="text" id="adv6_min_price" name="'.$this->field['name'].'[]" value="';
