<?php
    ...
    $all_pages_dashboard = array(
        ...
        'user_dashboard_floor'          =>  __( 'Add Floor plans', 'wpresidence-core' ),
  ...
  Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
           ...
           array(
                    ...
                    'type'     => 'text',
                    'title'    => __( 'Properties number per page in advanced search results', 'wpresidence-core' ),
                    'subtitle' => __( 'Properties number per page in advanced search results', 'wpresidence-core' ),
                    'default'  => '12'
            ),
            array(
                    ...
                    'subtitle' => __( 'Similar listings show when there are other properties from the same city, type and category.', 'wpresidence-core' ),
                    'default'  => '4'
            ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Half Map page - map position', 'wpresidence-core' ),
                'subtitle' => __( 'Half Map page - map position', 'wpresidence-core' ),
                'options'  => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'Maximum Height of the logo', 'wpresidence-core' ),
                'subtitle' => __( 'Maximum Height of the logo in px (ex: 60)', 'wpresidence-core' ),
            ),
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                    ...
                    'type'     => 'text',
                    'title'    => __( 'Header Phone Number header. Leave blank to show none', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Global transparent top bar?', 'wpresidence-core' ),
                'subtitle' => __( 'Enable or disable the use of transparent topbar globally.', 'wpresidence-core' ),
                'options'  => array(
                    'no' => 'no',
                    'yes'  => 'yes'
                    ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Separation border on top bar - global option?', 'wpresidence-core' ),
                'subtitle' => __( 'Enable or disable the use of topbar borders globally.', 'wpresidence-core' ),
                'options'  => array(
                    'no' => 'no',
                    'yes'  => 'yes'
                    ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Media Header Type for Taxonomy?', 'wpresidence-core' ),
                'subtitle' => __( 'Select what media header to use globally for taxonomies/categories.', 'wpresidence-core' ),
                'options'  => array(
                    'none',
                    'image',
                    'theme slider',
            ...
            array(
                    ...
                    'title'    => __( 'Taxonomy Header -  Revolution Slider', 'wpresidence-core' ),
                    'subtitle' => __( 'If media header is set to Revolution Slider, type the slider name and save.', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'title'    => __( 'Taxonomy Header Static Image', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Change text over header with user location?', 'wpresidence-core' ),
                'subtitle' => __( 'Works only for Image or Video Header', 'wpresidence-core' ),
                'options'  => array(
                    'yes'  => 'yes',
                    'no'   => 'no',
                    ),
   ...
   Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'title'    => __( 'Allow login via Twitter ?', 'wpresidence-core' ),
                'subtitle' => __( 'Allow login via Twitter ?(works only over https)', 'wpresidence-core' ),
                'options'  => array(
                             'no'  => 'no',
                             'yes' => 'yes'
                            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'What Map System you want to use?', 'wpresidence-core' ),
                'subtitle' => __( 'What map system you want to use', 'wpresidence-core' ),
                'options'  => array(
                            2 => 'open street',
                            1  => 'google maps' 
                            ),
...
//            ),
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'MapBox API KEY -  used for tile server', 'wpresidence-core' ),
                'subtitle' => __( 'You can get it from here: https://www.mapbox.com/. If you leave it blank we will use the default openstreet server which can be slow', 'wpresidence-core' ),
            ),
    ...
    $pin_fields[]=array(
     ...
     $pin_fields[]=array(
                ...
                'type'     => 'media',
                'title'    => __( 'Cloud Marker Image', 'wpresidence-core' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'Sticky sidebar will go over sticky footer.', 'wpresidence-core' ),
                'options'  => array(
                    'yes' => 'yes', 
                    'no'  => 'no'
            ...
            array(
             ...
             array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Media Header Type for Property Page?', 'wpresidence-core' ),
                'subtitle' => __( 'Media Header Type can be overwritten by Slider type.', 'wpresidence-core' ),
                'options'  => array(
                    'none',
                    'image',
                    'theme slider',
            ...
            array(
                    ...
                    'title'    => __( 'Property Header -  Revolution Slider', 'wpresidence-core' ),
                    'subtitle' => __( 'If media header is set to Revolution Slider, type the slider name and save.', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'title'    => __( 'Property Header Static Image', 'wpresidence-core' ),
                'subtitle' => __( 'If media header is set to image, and no image is added we will use the taxonomy featured image', 'wpresidence-core' ),         
            ),
            ...
            array(
                ...
                'options'  => array(
                            ...
                            'header masonry gallery'=>'header masonry gallery',
                            ),
                'default'  => 'horizontal',
            ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Show property details on 2 or 3 columns', 'wpresidence-core' ),
                'subtitle' => __( 'Address, Property details and Features & Amenities will be shown on 2 or 3 columns', 'wpresidence-core' ),
                'options'  => array(
                            '4'  => '3 Columns', 
                            '6' => '2 Columns'
                            ),
...
//             /   'desc'   => ' <img  style="border:1px solid #FFE7E7;margin-bottom:10px;" src="'.WPESTATE_PLUGIN_DIR_URL.'img/menu_types.png" alt="logo"/>'
    ...
    'fields'     => array(    
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Open link to property page in new window', 'wpresidence-core' ),
                'subtitle' => __( 'Open link to property page in new window', 'wpresidence-core' ),
                'options'  => array(
                                '_self'  => 'no', 
                                '_blank' => 'yes'
                            ),
...
E-mail: %user_email_register', 'wpresidence-core'),
                'desc'     => esc_html__('%user_login_register as new username and %user_email_register as new user email, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
Thank You!', 'wpresidence-core'),
                'desc'     => esc_html__('%reset_link as reset link, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
You can now login with your new password at: %website_url', 'wpresidence-core'),
                'desc'     => esc_html__('%user_pass as user password, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
The review is for agent %agent_name and was posted by %user_post.', 'wpresidence-core'),
                'desc'     => esc_html__('%agent_name as agent name,%user_post for the username (the one who post), use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
            ...
            array(
                ...
                'default'  => __('Hi there,
Your purchase on  %website_url is activated! You should go check it out.', 'wpresidence-core'),
                'desc'     => esc_html__('use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
You should go check it out.', 'wpresidence-core'),
                'desc'     => esc_html__('* you can use %post_id as listing id, %property_url as property url and %property_title as property name, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
Instructions:  %payment_details.', 'wpresidence-core'),
                'desc'     => esc_html__('* you can use %invoice_no as invoice number, %total_price as $totalprice and %payment_details as $payment_details, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
This is the property title: %submission_title.', 'wpresidence-core'),
                'desc'     => esc_html__('* you can use %submission_title as property title number, %submission_url as property submission url, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
If you do not wish to be notified anymore please enter your account and delete the saved search.Thank you!', 'wpresidence-core'),
                'desc'     => esc_html__('* you can use %matching_submissions as matching submissions list, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
Thank you!', 'wpresidence-core'),
                'desc'     => esc_html__('* you can use %expired_listing_url as expired listing url and %expired_listing_name as expired listing name, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
A user has submited a new property on %website_url! You should go check it out.This is the property title %new_listing_title!', 'wpresidence-core'),
            'desc'     => esc_html__('* you can use %new_listing_title as new listing title and %new_listing_url as new listing url, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
A user has edited one of his listings  on %website_url ! You should go check it out. The property name is : %editing_listing_title!', 'wpresidence-core'),
            'desc'     => esc_html__('* you can use %editing_listing_title as editing listing title and %editing_listing_url as editing listing url, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
...
We charged your account on %merchant for a subscription on %website_url ! You should go check it out.', 'wpresidence-core'),
            'desc'     => esc_html__('* you can use %recurring_pack_name as recurring packacge name and %merchant as merchant name, use text mode and <br class=""> tag for new line, <p class=""> for a new paragraph, <span class=""> for styling.', 'wpresidence-core'),
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'Info is taken from your account at https://dashboard.stripe.com/login See help: ', 'wpresidence-core' ).'<a href="https://help.wprentals.org/article/stripe-set-up/" target="_blank">https://help.wprentals.org/article/stripe-set-up/</a>',
            ),
        ),
    ) );
        ...
        'fields'     => array(
            ...
            array(
                ...
                'required' => array(
                    ...
                    array('wp_estate_adv_search_type','!=','8'),
            ...
            array(
                'id'       => 'wp_estate_force_location_only',
                'type'     => 'button_set',
                'title'    => __( 'On Home page - Show only location field', 'wpresidence-core' ),
                'subtitle' => __( 'On Home page - Show only location field - To be used on sites similar with trulia.com pr zillow.com', 'wpresidence-core' ),
                'options'  => array(
                            'no'  => 'no',
                            'yes' => 'yes'
                    ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'type'   => 'info',
                'notice' => false,
                'desc'   => 'WpResidence is MLSImport.com ready, a 3rd party plugin which can import IDX listings directly into WpResidence as if you would add them manually. Check out a demo with WpResidence & MLS Imported listings here: https://wpresidence.mlsimport.com/ '
            ),
            array(
