...
function wpestate_filter_list_properties($attributes, $content = null){
    ...
    $return_string.= '<div class="wpestate_filter_list_properties_wrapper" data-align="'.esc_attr($align).'">'.wpestate_shortcode_build_list($attributes).'
            ...
            <div class="item  '.$active.' " data-hash="item'.esc_attr($counter).'" data-href="'. esc_url( get_permalink() ).'" >
                ...
                <div class="image_div" style="background-image:url('.esc_url($preview[0]).');">
                    <div class="featured_gradient"></div>';
                        ...
                        if($featured==1){
                            $slides .= '<div class="featured_div">'.esc_html__('Featured','wpresidence').'</div>';
                        }
...
function wpestate_slider_recent_posts_pictures($attributes) {
    ...
    else if ($attributes['type'] == 'agents') {
        $type = 'estate_agent';
        $args = array(
            'post_type'      => $type,
            'post_status'    => 'publish',
   ...
   $items_per_row         =   intval( wpresidence_get_option('wp_estate_listings_per_row', '') );
    ...
    if($templates === false ){
        ...
        print '<div class="shortcode_slider_list '.$rand_class.' arrow_class_'.$arrows.' " data-items-per-row="'.$items_per_row.'" '.$is_autoscroll.'>';
...
function wpestate_login_form_function($attributes, $content = null) {
    ...
    $return_string='<div class="login_form shortcode-login" id="login-div">
         <div class="loginalert" id="login_message_area" >'.$mess.'</div>
                ...
                <div class="loginrow">
                    <input type="text" class="form-control" name="log" id="login_user" placeholder="'.esc_html__('Username','wpresidence-core').'" size="20" />
                </div>
                <div class="loginrow">
     ...
     $return_string='
          <div class="login_form shortcode-login">
               <div class="loginalert" id="register_message_area" ></div>
                ...
                <div class="loginrow">
                    <input type="text" name="user_login_register" id="user_login_register" class="form-control" placeholder="'.esc_html__('Username','wpresidence-core').'" size="20" />
                </div>
                <div class="loginrow">
