...
* @access   private
*/
add_action( 'init', 'wpestate_autocomplete_populate',1 );
            ...
            vc_map(
                array(
                    ...
                    array(
                            ...
                            "holder" => "div",
                            "class" => "",
                            "heading" => esc_html__("Show Featured Listings First (yes/no)","wpresidence-core"),
                            "param_name" => "featured_first",
                            "value" => $random_pick,
                            "description" => esc_html__("If 'yes'  featured properties will be displayed first, and the rest by ID(adding date).If 'no' all will be order by  ID(adding date) ","wpresidence-core") ,
        ...
        vc_map(
            ...
            vc_map(array(
               ...
               "params" => array( array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => esc_html__("Register link text","wpresidence-core"),
                     "param_name" => "register_label",
                     "value" => "",
                     "description" => esc_html__("Register link text","wpresidence-core")
                    )     , 
                    array(
                     "type" => "textfield",
                     "holder" => "div",
                     "class" => "",
                     "heading" => esc_html__("Register page url","wpresidence-core"),
                     "param_name" => "register_url",
                     "value" => "",
                     "description" => esc_html__("Register page url","wpresidence-core")
                  )      )
            )
            );
            ...
            vc_map(
             array(
               "name" => esc_html__("Register Form","wpresidence-core"),
               "base" => "register_form",
               "class" => "",
               "category" => esc_html__('Content','wpresidence-core'),
               'admin_enqueue_js' => array(WPESTATE_PLUGIN_DIR_URL.'/vc_extend/bartag.js'),
            ...
            vc_map(
                array(
                "name" => esc_html__("Testimonial Slider","wpresidence-core"),
                ...
                "params" => array(
                    array(
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => esc_html__("Visible Items","wpresidence-core"),
                        "param_name" => "visible_items",
                        "value" => "1",
                        "description" => esc_html__("How many items are visible","wpresidence-core")
                    )
                    , array(
                        "type"          =>  "dropdown",
                        "holder"        =>  "div",
...
/**
* generate agent data for autocomplete
* 
*
* @since    1.0
* @access   private
...
function wpestate_return_agent_array(){
  

    $agent_array    = false;
    if(function_exists('wpestate_request_transient_cache')){
        $agent_array = wpestate_request_transient_cache ('wpestate_js_composer_agent_array');
    }
    ...
    if($agent_array ===false ){
        ...
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_agent_array',$agent_array,60*60*4);
        }
    }
    return $agent_array;
}
...
/**
* generate article data for autocomplete
* 
*
* @since    1.0
* @access   private
*/
 function wpestate_return_article_array(){
    ...
    $article_array    = false;
    if(function_exists('wpestate_request_transient_cache')){
        $article_array = wpestate_request_transient_cache ('wpestate_js_composer_article_array');
    }
...
/**
* generate agetn tax data for autocomplete
* 
*
* @since    1.0
* @access   private
...
function wpestate_js_composer_out_agent_tax_array(){
    ...
    $out_agent_tax_array    = false;
    if(function_exists('wpestate_request_transient_cache')){
        $out_agent_tax_array = wpestate_request_transient_cache ('wpestate_js_composer_out_agent_tax_array');
    }
    ...
    if($out_agent_tax_array === false ){
        ...
        foreach( $agent_tax_list as $single_agent_tax ){
                ...
                foreach($terms_city as $term){					 
                        ...
                        $out_agent_tax_array[$single_agent_tax.'_label'][$term->term_id]=  $term->name;
                }

                // getting agent tax data END
        }
        if(function_exists('wpestate_set_transient_cache')){
            wpestate_set_transient_cache('wpestate_js_composer_out_agent_tax_array',$out_agent_tax_array,60*60*4);
        }
    }
