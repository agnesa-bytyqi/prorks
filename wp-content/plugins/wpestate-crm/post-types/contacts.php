...
add_action( 'setup_theme', 'wpestate_crm_create_contact_type',20);
...
function wpestate_crm_show_contact_details($lead_id){
    ...
    $return = '<div class="contact_crm_wrapper">';
        ...
        print '<div class="contact_crm_detail"><strong>'.esc_html__('Full Name','wpestate-crm').':</strong> '.get_post_meta($contact_id,'crm_first_name',true).'</div>';
        print '<div class="contact_crm_detail"><strong>'.esc_html__('Email','wpestate-crm').':</strong> '.get_post_meta($contact_id,'crm_email',true).'</div>';
        print '<div class="contact_crm_detail"><strong>'.esc_html__('Phone','wpestate-crm').':</strong>'.get_post_meta($contact_id,'crm_mobile',true).'</div>';
