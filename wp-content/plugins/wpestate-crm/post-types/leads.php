...
function wpestate_crm_add_lead($arguments){
    ...
    wpestate_create_crm_contact($arguments,$post_id);
}
...
function   wpestate_create_crm_contact($arguments,$lead_id){
    
    // check if contact inside db- via email
    
    $post = array(
            'post_title'	=> $arguments['contact_name'],
            'post_status'	=> 'publish', 
    ...
    $post_id =  wp_insert_post($post );  
    update_post_meta($post_id,'crm_email',$arguments['contact_email']);
    update_post_meta($post_id,'crm_first_name',$arguments['contact_name']);
    update_post_meta($post_id,'crm_email',$arguments['contact_email']);
    update_post_meta($post_id,'crm_mobile',$arguments['contact_mobile']);
    update_post_meta($post_id,'lead_contact',$lead_id);
    
    update_post_meta($lead_id,'lead_contact',$post_id);
