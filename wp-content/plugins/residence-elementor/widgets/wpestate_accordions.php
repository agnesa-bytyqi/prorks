...
class Wpresidence_Accordions extends Widget_Base {
	...
	public function get_title() {
		return __( 'WpResidence Accordions', 'residence-elementor' );
	}
				...
				foreach ( $accordions as $index => $item ) :
					...
					$this->add_render_attribute( $accordion_title_setting_key, [
						...
						'aria-controls' => 'elementor-accordion-content-' . $id_int . $accordion_count,
                                        ...
                                        ?>
                                        <div class="panel-group property-panel" id="<?php echo 'master_'.$item['_id'];?>">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <a data-toggle="collapse" data-parent="#<?php echo 'master_'.$item['_id'];?>" href="#<?php echo $item['_id'];?>">
                                                ...
                                                <div id="<?php echo $item['_id'];?>" class="panel-collapse collapse ">
