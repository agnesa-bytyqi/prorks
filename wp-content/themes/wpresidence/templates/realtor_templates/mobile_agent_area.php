...
$whatsup_mess='https://api.whatsapp.com/send?phone='.esc_html($realtor_details['realtor_mobile']).'&text='.esc_html('Hello I\'m interested in ','wpresidence').'['.get_the_title($prop_id).'] '.get_permalink($prop_id);
?>
    ...
    <div class="mobile_agent_area_details_wrapper">
        ...
        if ($realtor_details['realtor_mobile']!='') {
            print '<div class="agent_detail agent_phone_class"><a href="tel:'.esc_html($realtor_details['realtor_phone']).'"><i class="fas fa-phone"></i></a></div>';
        }
