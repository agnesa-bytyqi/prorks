...
<div class="<?php echo esc_html($col_data['col_class']);?> listing_wrapper property_unit_type6" 
    ...
    <div class="property_listing property_unit_type6 <?php echo wpestate_interior_classes($wpestate_uset_unit); ?> " 
        ...
        <?php if ($wpestate_uset_unit==1){
            ...
            <?php get_template_part('templates/property_cards_templates/property_card_details_type6'); ?>
